...
**L**ightness/**L**uminance/**I**ntensity：亮度，光的振幅，物体表面的反光率，表面色彩白色的多少
**V**alue/Brightness：明度，光源的明暗，人们所感知到的色彩明暗度
...
- M：max(R, G, B) 、m：min(R, G, B)、C：饱和度 = M - m
